...
class PessoasFixture extends TestFixture
{
    ...
    public $fields = [
        ...
        'dataNascimento' => ['type' => 'string', 'length' => 15, 'null' => true, 'default' => null, 'collate' => 'utf8_general_ci', 'comment' => '', 'precision' => null, 'fixed' => null],
        ...
        'tipo_pessoas_id' => ['type' => 'integer', 'length' => 11, 'unsigned' => false, 'null' => false, 'default' => null, 'comment' => '', 'precision' => null, 'autoIncrement' => null],
        '_indexes' => [
            'fk_pessoas_tipo_pessoas1_idx' => ['type' => 'index', 'columns' => ['tipo_pessoas_id'], 'length' => []],
        ],
        '_constraints' => [
            'primary' => ['type' => 'primary', 'columns' => ['id'], 'length' => []],
            'id_UNIQUE' => ['type' => 'unique', 'columns' => ['id'], 'length' => []],
            'fk_pessoas_tipo_pessoas1' => ['type' => 'foreign', 'columns' => ['tipo_pessoas_id'], 'references' => ['tipo_pessoas', 'id'], 'update' => 'noAction', 'delete' => 'noAction', 'length' => []],
        ],
        '_options' => [
            'engine' => 'InnoDB',
